async.parallel({
   ...
   activities: function(callback) {
    ...
    drawlinegraph3(results.sleepsum, "date", "timeAsleep", 1, "Cardinal", 1, "#sleep-graph3", 1, 1000, 160, "You slept ", " hours ","#AC4EBB", "rgba(172, 78, 187,0.2)","#AC4EBB");
    drawlinegraph3(results.activities, "startTime", "steps", 1, "Cardinal", 0, "#walk-graph3", 0, 120, 20, "You took ", " steps ","#AC4EBB", "rgba(172, 78, 187,0.2)","#AC4EBB");
    drawlinegraph3(results.activities, "startTime", "steps", 1, "Cardinal", 0, "#calorie-graph3", 0, 120, 20, "You burned ", " calories! ","#AC4EBB", "rgba(172, 78, 187,0.2)","#AC4EBB");
