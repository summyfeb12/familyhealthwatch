async.parallel({
   ...
   activities: function(callback) {
    ...
    //console.log(results);
    drawlinegraph1(results.bpheart, "timestamp", "heartRate", 1, "Cardinal", 1, "#heart-graph1", 1, 1000, 160, "Heart Rate is ", " bpm ","#FFF", "#2C3F51", "#2C3F51");
    drawlinegraph1(results.sleepsum, "date", "timeAsleep", 1, "Cardinal", 1, "#sleep-graph1", 1, 1000, 160, "You slept ", " hours ","#FFF", "#FF5024","#FF5024");
    drawlinegraph1(results.activities, "startTime", "steps", 1, "Cardinal", 0, "#walk-graph1", 0, 120, 20, "You took ", " steps ","blue", "#FF5024","blue");
    drawlinegraph1(results.activities, "startTime", "steps", 1, "Cardinal", 0, "#calorie-graph1", 0, 120, 20, "You burned ", " calories! ","blue", "#FF5024","blue");
    drawwaterfall1(results.bpheart, "#blood-graph1", 1000, 160);
