async.parallel({
   ...
   activities: function(callback) {
    ...
    //console.log(results);
    drawlinegraph(results.bpheart, "timestamp", "heartRate", 1, "Cardinal", 1, "#heart-graph", 1, 1000, 160, "Heart Rate is ", " bpm ","#FFF", "#2C3F51", "#2C3F51");
    drawlinegraph(results.sleepsum, "date", "timeAsleep", 1, "Cardinal", 1, "#sleep-graph", 1, 1000, 160, "You slept ", " hours ","#FFF", "#FF5024","#FF5024");
    drawlinegraph(results.activities, "startTime", "steps", 1, "Cardinal", 0, "#walk-graph", 0, 120, 20, "You took ", " steps ","blue", "#FF5024","blue");
    drawlinegraph(results.activities, "startTime", "steps", 1, "Cardinal", 0, "#calorie-graph", 0, 120, 20, "You burned ", " calories! ","blue", "#FF5024","blue");
